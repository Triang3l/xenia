...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_16 %uint_8 %uint_1
      ...
      %24686 = OpBitcast %int %15435
       %8391 = OpImageFetch %v4float %18624 %24686
      %10314 = OpCompositeExtract %float %8391 2
      %17935 = OpCompositeExtract %uint %11099 1
       %8831 = OpBitcast %int %17935
       %8392 = OpImageFetch %v4float %18624 %8831
      %10315 = OpCompositeExtract %float %8392 1
      %17936 = OpCompositeExtract %uint %11099 2
       %8832 = OpBitcast %int %17936
       %8372 = OpImageFetch %v4float %18624 %8832
       %9290 = OpCompositeExtract %float %8372 0
      %18032 = OpCompositeConstruct %v4float %10314 %10315 %9290 %float_1
...
const uint32_t apply_gamma_table_cs[] = {
    ...
    0x0000118F, 0x00000A0B, 0x0004003D, 0x00000011, 0x00003442, 0x00001E50,
    ...
    0x0005005F, 0x0000001D, 0x000020C7, 0x000048C0, 0x0000606E, 0x00050051,
    0x0000000D, 0x0000284A, 0x000020C7, 0x00000002, 0x00050051, 0x0000000B,
    0x0000460F, 0x00002B5B, 0x00000001, 0x0004007C, 0x0000000C, 0x0000227F,
    0x0000460F, 0x0005005F, 0x0000001D, 0x000020C8, 0x000048C0, 0x0000227F,
    0x00050051, 0x0000000D, 0x0000284B, 0x000020C8, 0x00000001, 0x00050051,
    0x0000000B, 0x00004610, 0x00002B5B, 0x00000002, 0x0004007C, 0x0000000C,
    0x00002280, 0x00004610, 0x0005005F, 0x0000001D, 0x000020B4, 0x000048C0,
    0x00002280, 0x00050051, 0x0000000D, 0x0000244A, 0x000020B4, 0x00000000,
    0x00070050, 0x0000001D, 0x00004670, 0x0000284A, 0x0000284B, 0x0000244A,
    0x0000008A, 0x0004003D, 0x000000A6, 0x00004B4F, 0x00000CBA, 0x00040063,
    0x00004B4F, 0x00002925, 0x00004670, 0x000200F9, 0x00005445, 0x000200F8,
